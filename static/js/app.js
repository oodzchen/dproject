(function () {
  ...
  const SITE = "dizkaz.com";
  const searchForm = document.getElementById("search-form");
  searchForm.onsubmit = function search(e) {
    e.preventDefault();
    ...
    let searchUrl = "";
    if (engine === "google") {
      searchUrl = `https://www.google.com/search?q=site:${SITE}+${encodeURIComponent(keywords)}`;
    } else {
      searchUrl = `https://www.bing.com/search?q=site:${SITE}+${encodeURIComponent(keywords)}`;
    }
