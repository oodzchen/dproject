DROP DATABASE IF EXISTS PLACEHOLD_DB_NAME;
DROP ROLE IF EXISTS PLACEHOLD_DB_USER;

CREATE ROLE PLACEHOLD_DB_USER WITH SUPERUSER CREATEDB CREATEROLE LOGIN PASSWORD 'PLACEHOLD_ADMIN_PASSWORD';
CREATE DATABASE PLACEHOLD_DB_NAME OWNER PLACEHOLD_DB_USER ENCODING 'UTF-8';

-- 连接到 discuss 数据库
\c PLACEHOLD_DB_NAME PLACEHOLD_DB_USER;
